# u_console_lib (UFO System console-blanks for ESP32)
...
This library is designed for runtime control system via UNIX-like console. It runs in the UFO environment and requires the installation of some dependent components (see below).
...
Console Templates for Working with Drivers, the File System, and the Configurator
...
|------------|--------|-----------|----------|
| [![u_cns](https://img.shields.io/badge/u_cns-0.5.0-blue.svg)](link) | ≥ 0.5.0 | UFO Console component | ASL |
...
| [![u_drivers](https://img.shields.io/badge/u_drivers-0.5.0-blue.svg)](link) | ≥ 0.5.0 | UFO Drivers API* | ASL |
| [![u_configurator](https://img.shields.io/badge/u_configurator-0.5.0-blue.svg)](link) | ≥ 0.5.0 | UFO Runtime configurator* | ASL |

\* \- if you have this lib in your project and pathes to header files are clear and can be reached from this lib files, its automaticaly enable (used preprocessors macroses) respective console-blank
